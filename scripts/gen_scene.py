...
LAT, LON = 29.58, 120.83  # Shengzhou, Zhejiang, China
TZ = "Asia/Shanghai"
...
def gen_footer(w, s):
    ...
    p.append('<g opacity="0"><animate attributeName="opacity" from="0" to="1" begin="2s" dur="0.8s" fill="freeze"/>'
             '<text x="450" y="198" text-anchor="middle" font-size="12" letter-spacing="2" fill="#8b949e">✦  Thanks for visiting  ✦</text></g>')
